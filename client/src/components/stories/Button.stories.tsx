...
export const Dark = () => {
    ...
    const theme = radios('theme', { Light: 'light', Dark: 'dark', Green: 'green' }, 'dark');
...
export const Green = () => {
    ...
    const theme = radios('theme', { Light: 'light', Dark: 'dark', Green: 'green' }, 'green');
